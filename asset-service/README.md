...
│   ├── http/              # Router and HTTP server setup
│   ├── models/            # Data models
...
You can use the curl examples above to test the APIs. Make sure to:

1. Replace the example UUIDs with actual UUIDs returned from your API calls
2. Ensure your database is properly configured and running
